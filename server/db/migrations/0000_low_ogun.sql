...
CREATE UNIQUE INDEX `primary_image_idx` ON `images` (`product_color_id`,`is_primary`) WHERE "images"."is_primary" = 1;--> statement-breakpoint
...
CREATE INDEX `stock_idx` ON `product_variants` (`quantity`);--> statement-breakpoint
CREATE INDEX `active_idx` ON `product_variants` (`is_active`);--> statement-breakpoint
